...
const MaterialsList = () => {
  const materialsData = [
    ...
    { icon: faLaptop, title: 'Eletrônicos', items: 'celulares, carregadores, notebooks, computadores, teclados, mouses, televisores, monitores, rádios, câmeras, pilhas, baterias, controles remotos, eletrodomésticos pequenos, entre outros. A Coleta Amiga realiza a coleta, e posteriormente a ACAMAR encaminha os materiais para uma empresa especializada em logística reversa.' },
  ];
