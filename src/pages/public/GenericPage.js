...
const QuemSomosContent = () => {
  ...
  return (
    <div className="content-wrapper">
      ...
      <h4 className="subtitulo-centralizado">Localização UVR</h4><div className="map-container"><iframe src="https://maps.app.goo.gl/KzruMXMMVLNMk8nd8" width="100%" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Localização da ACAMAR no Google Maps"></iframe></div>
    </div>
  );
};
